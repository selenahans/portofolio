const Footer = () => {
  return (
    <div className="mt-32 py-4 flex md:flex-row flex-col gap-6 md:gap-0 justify-between items-center max-w-6xl mx-auto">
      <h1 className="text-2xl font-bold text-[#675D54]">
        {" "}
        Selena's Portofolio{" "}
      </h1>
      <div className="flex items-center gap-3">
        ...
        <a href="https://www.behance.net/selenahans">
          <i className="ri-behance-fill ri-2x text-[#A39383] transition-all duration-300 ease-in-out hover:scale-125 hover:text-[#675D54]"></i>
        </a>
      </div>
    </div>
  );
