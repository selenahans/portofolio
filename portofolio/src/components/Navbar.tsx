...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-8 flex justify-between items-center">
      ...
      md:opacity-100  bg-white/30 backdrop-blur-md p-4 rounded-br-2x1 rounded-bl-2xl md:bg-transparent transition-all md:transition-none z-40 ${active ? 'top-0 opacity-100' : '-top-10 opacity-0'}`}>
        <li>
          <a className="font-medium sm:text-lg text-base" href="#home">home</a>
        </li>
        <li>
          <a className="font-medium sm:text-lg text-base" href="#tentang">project</a>
        </li>
        <li>
